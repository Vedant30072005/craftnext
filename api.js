...
const Auth = {
  ...
  forgotPasswordOTP: (email) => apiRequest("/auth/forgot-password-otp", "POST", { email }),
  resetPassword: (email, token, newPassword) => apiRequest("/auth/reset-password", "POST", { email, token, newPassword }),
  resetPasswordOTP: (email, otp, newPassword) => apiRequest("/auth/reset-password-otp", "POST", { email, otp, newPassword }),
